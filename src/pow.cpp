...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
{
    ...
    // Lithium inherits the same early retarget logic as Blakecoin, but after
    // height 150000 it intentionally looks back a full interval instead of
    // interval-1 blocks to avoid a retarget manipulation edge case.
    ...
    // Go back by the number of blocks the legacy Lithium code used for the
    // retarget window at this height.
