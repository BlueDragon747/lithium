    ...
    : QWidget()
{
    ...
    // draw the Lithium icon, expected size of PNG: 1024x1024.
    // Keep the cropped-coin splash style, but preserve the same hard gap used
    // by BlakeBitcoin and UniversalMolecule so the title remains readable.
