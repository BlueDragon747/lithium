...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Lithium/Lithium-Qt.conf and all else left as default,
    // lithium-qt should set both -listen and -listenonion to false and start successfully.
