...
static boost::signals2::connection rpcNotifyBlockChangeConn;

void OnRPCStarted()
{
    rpcNotifyBlockChangeConn = uiInterface.NotifyBlockTip.connect(&RPCNotifyBlockChange);
}

void OnRPCStopped()
{
    rpcNotifyBlockChangeConn.disconnect();
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BlueDragon747/lithium>";
    const std::string URL_WEBSITE = "<https://github.com/BlueDragon747/lithium>";
