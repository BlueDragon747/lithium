...
REGTEST_GENESIS = "000000fcf39055b547e94e610f1008b8046f942bbb730e8b6dfa6232931902db"
...
class RejectLowDifficultyHeadersTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-minimumchainwork=0x0", "-checkblockindex=0"], ["-minimumchainwork=0x100011d", "-checkblockindex=0"], ["-minimumchainwork=0x10010fd", "-checkblockindex=0"], ["-minimumchainwork=0x10010fd", "-checkblockindex=0", "-whitelist=noban@127.0.0.1"]]
