...
def translate_testnet_address(address):
    ...
    if version == 111:
        return byte_to_base58(payload, 26)
    if version == 196:
...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        common_address = translate_testnet_address("msf4WtN1YQKXvNtvdFYt9JBnUD2FB41kjr")
        node.sendmany(
        ...
        if self.options.descriptors:
            ...
            BECH32_VALID = {
                '✔️_VER15_PROG40': translate_testnet_address('bcrt10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxkg7fn'),
                '✔️_VER16_PROG03': translate_testnet_address('bcrt1sqqqqq8uhdgr'),
                '✔️_VER16_PROB02': translate_testnet_address('bcrt1sqqqq4wstyw'),
            }
            BECH32_INVALID = {
                '❌_VER15_PROG41': 'rlit1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqajlxj8',
                '❌_VER16_PROB01': 'rlit1sqq5r4036',
            }
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Lithium address or script",
