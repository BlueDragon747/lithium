...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "LIT/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Expected fee is 141 vbytes * fee_rate 0.00350250 LIT / 1000 vbytes = 0.00049385 LIT.
    # or occasionally 140 vbytes * fee_rate 0.00350250 LIT / 1000 vbytes = 0.00049035 LIT.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 LIT.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 LIT / 1000 vbytes = 0.00002820 LIT
...
def test_watchonly_psbt(self, peer_node, rbf_node, dest_address):
    ...
    priv_rec_desc = descsum_create(f"wpkh([00000001/84'/1'/0']{xpriv}/0/*)")
    pub_rec_desc = rbf_node.getdescriptorinfo(priv_rec_desc)["descriptor"]
    priv_change_desc = descsum_create(f"wpkh([00000001/84'/1'/0']{xpriv}/1/*)")
