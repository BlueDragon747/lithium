...
class MinimumChainWorkTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [[], [f"-minimumchainwork={MIN_CHAIN_WORK:#x}"], [f"-minimumchainwork={MIN_CHAIN_WORK:#x}"]]
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing relay across node 1 (minChainWork = {MIN_CHAIN_WORK:#x})")

        starting_blockcount = self.nodes[2].getblockcount()

        # Lithium regtest chainwork starts at 0x1000100 and increases by 2 per block.
        # 49 blocks reaches 0x1000162, still below MIN_CHAIN_WORK. One more block exceeds it.
        num_blocks_to_generate = 49
