...
MAGIC_BYTES = {
    "mainnet": b"\xf9\xbc\xb4\xd2",   # Lithium mainnet (byte 2 is 0xbc, not 0xbe like Lithium)
    "testnet3": b"\x0b\x11\x09\x08",  # Lithium testnet
    "regtest": b"\xfa\xbf\xb5\xda",   # Lithium regtest (matches Bitcoin/Lithium regtest convention)
    "signet": b"\x54\xd2\x6f\xbd",    # Lithium signet (developer-only, defaults like Bitcoin)
}
