...
class AcceptBlockTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 2
        # Lithium regtest chainwork stays near 0x1000000 over short functional
        # runs, so choose a threshold that rejects the step-2 low-work block while
        # still allowing the height-290 chain from node0 to sync in step 9.
        self.extra_args = [[], ["-minimumchainwork=0x1000200"]]
