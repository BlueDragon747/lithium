...
class CreateTxWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Lithium regtest rejects hand-built blocks at the genesis timestamp;
        # start one spacing interval later so `generate()` actually advances.
        self.nodes[0].setmocktime(TIME_GENESIS_BLOCK + 600)
