...
"""Test framework for Lithium utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "lithium-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    exec_name = testObj["exec"]
    execprog = os.path.join(buildenv["BUILDDIR"], "src", exec_name + buildenv["EXEEXT"])
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, lithium-tx
