...
# Extract options
function __fish_lithium_tx_get_options
...
# Extract commands
function __fish_lithium_tx_get_commands
...
complete \
    --command lithium-tx \
    --condition "not __fish_lithium_seen_cmd (__fish_lithium_tx_get_commands --commandsonly)" \
    --arguments "(__fish_lithium_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command lithium-tx \
    --arguments "(__fish_lithium_tx_get_commands)" \
    --no-files
