...
complete --command lithiumd --no-files

# Extract options
function __fish_lithiumd_get_options
...
complete \
    --command lithiumd \
    --arguments "(__fish_lithiumd_get_options --nofiles)"
