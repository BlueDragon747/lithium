...
complete --command lithium-qt --no-files

# Extract options
function __fish_lithiumqt_get_options
...
complete \
    --command lithium-qt \
    --arguments "(__fish_lithiumqt_get_options --nofiles)"
