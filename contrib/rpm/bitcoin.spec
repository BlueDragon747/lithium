...
Encoding=UTF-8
Name=Lithium
Comment=Lithium P2P Cryptocurrency
Comment[fr]=Lithium, monnaie virtuelle cryptographique pair à pair
Comment[tr]=Lithium, eşten eşe kriptografik sanal para birimi
Exec=lithium-qt %u
Terminal=false
Type=Application
Icon=bitcoin128
MimeType=x-scheme-handler/lithium;
