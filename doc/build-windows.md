...
Below are some notes on how to build Lithium Core for Windows.
...
way. This will install to `c:\workspace\lithium`, for example:

    make install DESTDIR=/mnt/c/workspace/lithium
